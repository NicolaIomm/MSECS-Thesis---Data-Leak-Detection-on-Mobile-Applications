...
\usepackage{multirow}
	...
	% font size -> D:\TexLive\2022\texmf-dist\tex\latex\sapthesis\sapthesis.cls -> modify text size -> currently 12
	% interline directives
\onehalfspacing
...
\definecolor{listingBackgroundColor}{rgb}{0.9,0.9,0.9}
...
\begin{document}
	...
	\mainmatter
		...
		\input{chapters/testing_environment.tex}
	...
	\backmatter
		...
		\begin{thebibliography}{99}
			\bibitem{ips} IPS Communication Intelligence Solutions \newline
			...
			\bibitem{protocol_buffer} Protocol Buffers Docs - Overview \newline
			\url{https://protobuf.dev/overview/}
			\bibitem{grpc} gRPC.io - Docs \newline
			\url{https://grpc.io/docs/}
			\bibitem{rfc9000} IETF - RFC 9000 \newline
			\url{https://datatracker.ietf.org/doc/html/rfc9000}
			\bibitem{rfc9114} IETF - RFC 9114 \newline
			...
			\bibitem{burp_suite} PortSwigger - Configuring Android device to work with Burp Suite\newline
			\url{https://portswigger.net/burp/documentation/desktop/mobile/config-android-device}
			\bibitem{frida} Frida.re - Docs\newline
			\url{https://frida.re/docs/home/}
			\bibitem{objection} GitHub - Objection Docs\newline
			\url{https://github.com/sensepost/objection}
			\bibitem{gda} GitHub - GDA\newline
